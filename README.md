...
- **Mâna interactivă** - Punct de ancorare pentru escaladare cu mișcare fluidă
- **Management al staminei** - Regenerare progresivă și consum în timp real
- **Sistem de momentum** - Viteza de alergare se transferă în forța swingului
- **Fizică realista** - Utilizează RigidBody și PhysicMaterial pentru interacțiuni naturale

### 🎮 Obiecte și Mecanici de Nivel
- **Platforme Rotative** - Se rotesc constant, complicând traversarea
- **Platforme Mobile** - Se deplasează pe o cale predefinită cu pauze la fiecare punct
- **Teleporturi** - Transportă jucătorul la puncte specifice, resetând viteza
- **Flag de Victorie** - Marchează finalizarea nivelului cu sistem de stele

### 🔊 Sistem de Audio
- **Sunet de vânt dinamic** - Se adapteaza la viteza de mișcare a jucătorului
- **Sunet de pași** - Se redă când jucătorul este pe teren

### 💾 Sistem de Salvare și Progresie
- **Unlock de nivele** - Progresie liniară prin nivele
- **Personal Best Tracking** - Registrează cel mai bun timp pe fiecare nivel
- **Sistem de Stele** - 0-3 stele bazate pe timp de completare
- **Salvare Setări** - Volum master și sensibilitate mouse persistent

### 🖼️ UI și Meniuri
- **Main Menu** - Intrare în joc cu navigație fluidă
- **Level Select** - Selectare și încărcarea nivelurilor
- **Loading Screen** - Animații în timp ce se încarcă nivelul
- **Timer UI** - Afișare timp real în joc și pentru calcul stele
- **Stamina Bar** - Afișare vizuală a nivelului de oboseală
- **Win Menu** - Rezultate și opțiuni după finalizare nivel
